...
import {Button, Card, Flex, Form, FormProps, Input, Space} from "antd";
import React from "react";
import {AccountsService} from "@/services/accounts/AccountsService";

const onFinish: FormProps<FormFields>["onFinish"] = async (values) => {
    const response = await AccountsService.loginAccount({
        Email: values.email,
...
const SignIn: React.FC = () => {
    return (
        <Space direction="vertical" size={16}>
            <Card title="Sign-in" style={{width: "32rem"}}>
                <Form
                    name="basic"
                    labelCol={{span: 8}}
                    wrapperCol={{span: 16}}
                ...
                >
                    ...
                    <Form.Item wrapperCol={{offset: 8, span: 16}}>
                        <Flex gap={"small"}>
                            ...
                            <Button type="text">I forgot my password</Button>
                        </Flex>
                    </Form.Item>
                </Form>
            </Card>
